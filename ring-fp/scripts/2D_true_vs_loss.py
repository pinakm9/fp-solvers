...
#                            net_name='ring2D', num_pts=1000, num_mc_pts=int(1e5), num_nodes=50, num_blocks=3, dtype=tf.float32,\
#                            name="ring{}D".format(dim))
...
compare.plot_evolution(steps=range(100, 10000, 100), low=[-2., -2.], high=[2., 2.], resolution=30,                           truth=p_inf, mc_domain=[[-3., -3.], [3., 3.]], num_mc_pts=int(1e5),
                           ...
                           net_name='ring2D', num_nodes=50, num_blocks=3, dtype=tf.float32,\
                           name="ring{}D".format(dim))